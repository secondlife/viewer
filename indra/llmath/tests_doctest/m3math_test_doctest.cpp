// doctest translation of m3math_test.cpp
#include "doctest.h"
...
TUT_SUITE("m3math_test")
{
    //test case for setIdentity() fn.
    TUT_CASE("m3math_test::m3math_test_object_t_test_1")
    {
        using namespace tut;

        LLMatrix3 llmat3_obj;
        llmat3_obj.setIdentity();
        TUT_ENSURE("LLMatrix3::setIdentity failed", 1.f == llmat3_obj.mMatrix[0][0] &&
    ...
    TUT_CASE("m3math_test::m3math_test_object_t_test_2")
    {
        using namespace tut;
        ...
        TUT_ENSURE("LLMatrix3::setZero failed", 0.f == llmat3_obj.setZero().mMatrix[0][0] &&
    ...
    TUT_CASE("m3math_test::m3math_test_object_t_test_3")
    {
        using namespace tut;
        ...
        TUT_ENSURE("LLVector3::setRows failed ", 2 == llmat3_obj.mMatrix[0][0] &&
    ...
    TUT_CASE("m3math_test::m3math_test_object_t_test_4")
    {
        using namespace tut;
        ...
        TUT_ENSURE("LLVector3::getFwdRow failed ", vect1 == llmat3_obj.getFwdRow());
        TUT_ENSURE("LLVector3::getLeftRow failed ", vect2 == llmat3_obj.getLeftRow());
        TUT_ENSURE("LLVector3::getUpRow failed ", vect3 == llmat3_obj.getUpRow());
    }

    //test case for operator*(const LLMatrix3 &a, const LLMatrix3 &b)
    TUT_CASE("m3math_test::m3math_test_object_t_test_5")
    {
        using namespace tut;
        ...
        TUT_ENSURE("LLMatrix3::operator*(const LLMatrix3 &a, const LLMatrix3 &b) failed",
    ...
    TUT_CASE("m3math_test::m3math_test_object_t_test_6")
    {
        using namespace tut;
        ...
        TUT_ENSURE("LLMatrix3::operator*(const LLVector3 &a, const LLMatrix3 &b) failed", res_vec == expected_result);
    }

    //test case for operator*(const LLVector3d &a, const LLMatrix3 &b)
    TUT_CASE("m3math_test::m3math_test_object_t_test_7")
    {
        using namespace tut;
        ...
        TUT_ENSURE("LLMatrix3::operator*(const LLVector3 &a, const LLMatrix3 &b) failed", llvec3d1 == expected_result);
    }

    // test case for operator==(const LLMatrix3 &a, const LLMatrix3 &b)
    TUT_CASE("m3math_test::m3math_test_object_t_test_8")
    {
        using namespace tut;
        ...
        TUT_ENSURE("LLMatrix3::operator==(const LLMatrix3 &a, const LLMatrix3 &b) failed", llmat_obj1 == llmat_obj2);
    ...
    TUT_CASE("m3math_test::m3math_test_object_t_test_9")
    {
        using namespace tut;
        ...
        TUT_ENSURE("LLMatrix3::quaternion failed ", is_approx_equal(-0.66666669f, llmat_quat.mQ[0]) &&
    ...
    TUT_CASE("m3math_test::m3math_test_object_t_test_10")
    {
        using namespace tut;
        ...
        TUT_ENSURE("LLMatrix3::transpose failed ", llmat_obj == expectedllmat_obj);
    }

    //test case for determinant() fn.
    TUT_CASE("m3math_test::m3math_test_object_t_test_11")
    {
        using namespace tut;
        ...
        LLVector3 llvec3(2, 2, 2);
        llmat_obj1.setRows(llvec1, llvec2, llvec3);
        TUT_ENSURE("LLMatrix3::determinant failed ",  0.0f == llmat_obj1.determinant());
    }

    //test case for orthogonalize() fn.
    TUT_CASE("m3math_test::m3math_test_object_t_test_12")
    {
        using namespace tut;
        ...
        INFO("Skipping original TUT case: architecture-dependent comparison");
        return;

        llmat_obj.setRows(llvec1, llvec2, llvec3);
        llmat_obj.orthogonalize();

        TUT_ENSURE("LLMatrix3::orthogonalize failed ",
    ...
    TUT_CASE("m3math_test::m3math_test_object_t_test_13")
    {
        using namespace tut;
        ...
        TUT_ENSURE("LLMatrix3::adjointTranspose failed ", 10 == llmat_obj.mMatrix[0][0] &&
