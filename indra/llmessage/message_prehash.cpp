...
char const* const _PREHASH_AgentAnimationTracking = LLMessageStringTable::getInstance()->getString("AgentAnimationTracking");
char const* const _PREHASH_AttachmentPointUpdate = LLMessageStringTable::getInstance()->getString("AttachmentPointUpdate");
char const* const _PREHASH_AnimationControl = LLMessageStringTable::getInstance()->getString("AnimationControl");
char const* const _PREHASH_AnimationParams = LLMessageStringTable::getInstance()->getString("AnimationParams");
char const* const _PREHASH_ReportPeriod = LLMessageStringTable::getInstance()->getString("ReportPeriod");
char const* const _PREHASH_BoneControl = LLMessageStringTable::getInstance()->getString("BoneControl");
char const* const _PREHASH_EaseInTime = LLMessageStringTable::getInstance()->getString("EaseInTime");
char const* const _PREHASH_EaseInMethod = LLMessageStringTable::getInstance()->getString("EaseInMethod");
char const* const _PREHASH_HoldTime = LLMessageStringTable::getInstance()->getString("HoldTime");
char const* const _PREHASH_EaseOutTime = LLMessageStringTable::getInstance()->getString("EaseOutTime");
char const* const _PREHASH_EaseOutMethod = LLMessageStringTable::getInstance()->getString("EaseOutMethod");
char const* const _PREHASH_ChainLen = LLMessageStringTable::getInstance()->getString("ChainLen");
