/**
 * @file llthreadsafeworkerpool.cpp
...
llThreadSafeWorkerPool::llThreadSafeWorkerPool() :
 ...
 */
void llThreadSafeWorkerPool::cleanupSingleton()
{
    /**
     * Note:
 ...
 */
void llThreadSafeWorkerPool::requestThread()
{
    /**
...
BOOL llThreadSafeWorkerPool::tick()
{
    /**
 ...
 */
void llThreadSafeWorkerPool::addReadRequest(std::string id,
 ...
 * once the request is processed
 */
llThreadSafeWorkerPool::request_payload_t
llThreadSafeWorkerPool::waitForReadComplete(std::string id,
                                 LLAssetType::EType at,
                                 unsigned long pos,
                                 unsigned long bytes)
{
    ...
    if (LLCoros::getName().empty() && on_main_thread())
    {
        ...
        addReadRequest(id, at, pos, bytes, [&done, &succeeded, &payload_out, &filename_out]
                       (llThreadSafeWorkerPool::request_payload_t payload_in, std::string filename_in, bool result)
        {
            /**
 ...
 */
void llThreadSafeWorkerPool::addWriteRequest(std::string id,
                                  LLAssetType::EType at,
 ...
 * once the request is processed.
 */
void llThreadSafeWorkerPool::addRenameRequest(std::string old_id,
 ...
 * once the request is processed.
 */
void llThreadSafeWorkerPool::addRemoveRequest(std::string id,
                                   LLAssetType::EType at,
                                   request_callback_t cb)
{
    /**
 ...
 */
const std::string llThreadSafeWorkerPool::assetTypeToString(LLAssetType::EType at)
{
    /**
 ...
 * is made)
 */
const std::string llThreadSafeWorkerPool::idToFilepath(const std::string id, LLAssetType::EType at)
{
    /**
