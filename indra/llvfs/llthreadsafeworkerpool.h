...
#ifndef _LLTHREADSAFEWORKERPOOL
#define _LLTHREADSAFEWORKERPOOL
...
class llThreadSafeWorkerPool :
    public LLSingleton<llThreadSafeWorkerPool>,
    public LLEventTimer
{
        LLSINGLETON(llThreadSafeWorkerPool);

    public:
        virtual ~llThreadSafeWorkerPool() = default;
