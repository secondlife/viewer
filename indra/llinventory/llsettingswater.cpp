...
LLSettingsWater::validation_list_t LLSettingsWater::validationList()
{
    ...
    if (validation.empty())
    {
        validation.push_back(Validator(SETTING_BLUR_MULTIPLIER, true, LLSD::TypeReal,
            [](LLSD &value, U32 flags){ return Validator::verifyFloatRange(value, flags, llsd::array(-0.5f, 0.5f)); }));
        ...
        validation.push_back(Validator(SETTING_FOG_DENSITY, true, LLSD::TypeReal,
            [](LLSD &value, U32 flags){ return Validator::verifyFloatRange(value, flags, llsd::array(-10.0f, 10.0f)); }));
        ...
        validation.push_back(Validator(SETTING_SCALE_ABOVE, true, LLSD::TypeReal,
            [](LLSD &value, U32 flags){ return Validator::verifyFloatRange(value, flags, llsd::array(0.0f, 3.0f)); }));
