...
TUT_SUITE("LLInventory")
{

//***class LLInventoryType***//


        TUT_CASE("LLInventory::inventory_object_test_1")
    {
        using namespace tut;
        ...
        TUT_CASE("LLInventory::inventory_object_test_2")
    {
        using namespace tut;
        ...
        TUT_CASE("LLInventory::inventory_object_test_3")
    {
        using namespace tut;
        ...
        TUT_CASE("LLInventory::inventory_object_test_4")
    {
        using namespace tut;
...
//*****class LLInventoryItem*****//
        ...
        TUT_CASE("LLInventory::inventory_object_test_5")
    {
        using namespace tut;
        ...
        TUT_CASE("LLInventory::inventory_object_test_6")
    {
        ...
        TUT_CASE("LLInventory::inventory_object_test_7")
    {
        using namespace tut;
        ...
        TUT_CASE("LLInventory::inventory_object_test_8")
    {
        using namespace tut;
        LLPointer<LLInventoryItem> src1 = create_random_inventory_item();
        ...
        TUT_CASE("LLInventory::inventory_object_test_9")
    {
        using namespace tut;
        ...
        TUT_CASE("LLInventory::inventory_object_test_11")
    {
        using namespace tut;
        LLPointer<LLInventoryItem> src1 = create_random_inventory_item();
...
//******class LLInventoryCategory*******//
        ...
        TUT_CASE("LLInventory::inventory_object_test_12")
    {
        using namespace tut;
        ...
        TUT_CASE("LLInventory::inventory_object_test_13")
    {
        using namespace tut;
        std::string filename("linden_file.dat");
        llofstream fileXML(filename.c_str());
        ...
        TUT_CASE("LLInventory::inventory_object_test_14")
    {
        using namespace tut;
        LLPointer<LLInventoryCategory> src1 = create_random_inventory_cat();
