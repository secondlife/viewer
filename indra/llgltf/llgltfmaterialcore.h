...
class LLGLTFMaterialCore : public LLRefCount
{
public:

    // default material for reference
    static const LLGLTFMaterialCore sDefault;
    ...
    LLGLTFMaterialCore();
    LLGLTFMaterialCore(const LLGLTFMaterialCore& rhs);

    LLGLTFMaterialCore& operator=(const LLGLTFMaterialCore& rhs);
    bool operator==(const LLGLTFMaterialCore& rhs) const;
    bool operator!=(const LLGLTFMaterialCore& rhs) const { return !(*this == rhs); }
    ...
    virtual void applyOverride(const LLGLTFMaterialCore& override_mat);
    ...
    void getOverrideLLSD(const LLGLTFMaterialCore& override_mat, LLSD& data) const;
    ...
    void setBaseMaterial(const LLGLTFMaterialCore& old_override_mat);
    // True if setBaseMaterial() was just called
    bool isClearedForBaseMaterial() const;

    // Todo: move to llgltfmaterial.h
