...
// Doesn't need additional locking - only accessed from main thread
void BlockTimer::pushLogExtraRecord(const std::string& name, LLSD& sd)
{
    sExtraLogRecords[name] = sd;
}
