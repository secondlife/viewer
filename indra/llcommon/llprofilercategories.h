...
#if LL_PROFILER_CATEGORY_ENABLE_INVENTORY
#define LL_PROFILE_ZONE_NAMED_CATEGORY_INVENTORY LL_PROFILE_ZONE_NAMED
#define LL_PROFILE_ZONE_SCOPED_CATEGORY_INVENTORY LL_PROFILE_ZONE_SCOPED
#else
#define LL_PROFILE_ZONE_NAMED_CATEGORY_INVENTORY(name)
#define LL_PROFILE_ZONE_SCOPED_CATEGORY_INVENTORY
#endif
