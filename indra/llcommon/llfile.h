...
public:
    ...
    */
    ...
    typedef std::ios_base::seekdir seekdir_t;
    static const seekdir_t beg = std::ios_base::beg;
    static const seekdir_t cur = std::ios_base::cur;
    static const seekdir_t end = std::ios_base::end;
    ///@}
    ...
    int seek(S64 offset, LLFile::seekdir_t seekdir, std::error_code& ec);
    ///< @returns 0 on success, -1 on failure
...
private:
    ...
    openmode_t mOpen;        // Used to emulate std::ios_base::app under Windows
};
