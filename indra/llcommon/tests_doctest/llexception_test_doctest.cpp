/**
 * @file llexception_test_doctest.cpp
 * @date   2025-02-18
 * @brief doctest: unit tests for LL exception
 *
...
TUT_SUITE("llcommon")
{
    ...
    {
        DOCTEST_FAIL("Unported TUT case: llexception_test.cpp::object::test<1>");
        // Original snippet:
        // template<> template<>
        //     void object::test<1>()
        //     {
    ...
    {
        DOCTEST_FAIL("Unported TUT case: llexception_test.cpp::object::test<2>");
        // Original snippet:
        // template<> template<>
        //     void object::test<2>()
        //     {
