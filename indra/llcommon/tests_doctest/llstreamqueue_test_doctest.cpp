/**
 * @file llstreamqueue_test_doctest.cpp
 * @date   2025-02-18
 * @brief doctest: unit tests for LL streamqueue
 *
...
TUT_SUITE("llcommon")
{
    ...
    {
        DOCTEST_FAIL("Unported TUT case: llstreamqueue_test.cpp::object::test<1>");
        // Original snippet:
        // template<> template<>
        //     void object::test<1>()
        //     {
    ...
    {
        DOCTEST_FAIL("Unported TUT case: llstreamqueue_test.cpp::object::test<2>");
        // Original snippet:
        // template<> template<>
        //     void object::test<2>()
        //     {
    ...
    {
        DOCTEST_FAIL("Unported TUT case: llstreamqueue_test.cpp::object::test<3>");
        // Original snippet:
        // template<> template<>
        //     void object::test<3>()
        //     {
    ...
    {
        DOCTEST_FAIL("Unported TUT case: llstreamqueue_test.cpp::object::test<4>");
        // Original snippet:
        // template<> template<>
        //     void object::test<4>()
        //     {
    ...
    {
        DOCTEST_FAIL("Unported TUT case: llstreamqueue_test.cpp::object::test<5>");
        // Original snippet:
        // template<> template<>
        //     void object::test<5>()
        //     {
    ...
    {
        DOCTEST_FAIL("Unported TUT case: llstreamqueue_test.cpp::object::test<6>");
        // Original snippet:
        // template<> template<>
        //     void object::test<6>()
        //     {
