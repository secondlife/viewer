...
TUT_SUITE("llcommon")
{
    ...
    {
        DOCTEST_FAIL("Unported TUT case: lllazy_test.cpp::lllazy_object::test<1>");
        // Original snippet:
        // template<> template<>
    ...
    {
        DOCTEST_FAIL("Unported TUT case: lllazy_test.cpp::lllazy_object::test<2>");
        // Original snippet:
        // template<> template<>
    ...
    {
        DOCTEST_FAIL("Unported TUT case: lllazy_test.cpp::lllazy_object::test<3>");
        // Original snippet:
        // template<> template<>
    ...
    {
        DOCTEST_FAIL("Unported TUT case: lllazy_test.cpp::lllazy_object::test<4>");
        // Original snippet:
        // template<> template<>
