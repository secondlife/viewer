...
struct llsd_select_bool : public unary_function<LLSD, LLSD::Boolean>
{
...
struct llsd_select_integer : public unary_function<LLSD, LLSD::Integer>
{
...
struct llsd_select_real : public unary_function<LLSD, LLSD::Real>
{
...
struct llsd_select_float : public unary_function<LLSD, F32>
{
...
struct llsd_select_uuid : public unary_function<LLSD, LLSD::UUID>
{
...
struct llsd_select_string : public unary_function<LLSD, LLSD::String>
{
