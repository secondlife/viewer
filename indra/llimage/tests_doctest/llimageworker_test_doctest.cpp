...
TUT_SUITE("LLImageDecodeThread")
{
    TUT_CASE("LLImageDecodeThread::imagedecodethread_object_t_test_1")
    {
        using namespace tut;
        imagedecodethread_test data;
        LLImageDecodeThread*& mThread = data.mThread;
