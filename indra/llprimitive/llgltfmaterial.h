...
class LLGLTFMaterial : public LLGLTFMaterialCore
{
public:
    LLGLTFMaterial() : LLGLTFMaterialCore() {}
    LLGLTFMaterial(const LLGLTFMaterial& rhs) : LLGLTFMaterialCore(rhs) {}
    LLGLTFMaterial(const LLGLTFMaterialCore& rhs) : LLGLTFMaterialCore(rhs) {}
