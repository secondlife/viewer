...
TUT_SUITE("LLJoint")
{
    TUT_CASE("LLJoint::lljoint_object_test_1")
    {
        using namespace tut;
        LLJoint lljoint;
    ...
    TUT_CASE("LLJoint::lljoint_object_test_2")
    {
        using namespace tut;
    ...
    TUT_CASE("LLJoint::lljoint_object_test_3")
    {
        using namespace tut;
    ...
    TUT_CASE("LLJoint::lljoint_object_test_4")
    {
        using namespace tut;
        LLJoint parent;
    ...
    TUT_CASE("LLJoint::lljoint_object_test_5")
    {
        using namespace tut;
        LLJoint lljoint;
    ...
    TUT_CASE("LLJoint::lljoint_object_test_6")
    {
        using namespace tut;
        LLJoint lljoint;
        LLVector3 vec3(2.3f,30.f,10.f);
    ...
    TUT_CASE("LLJoint::lljoint_object_test_7")
    {
        using namespace tut;
    ...
    TUT_CASE("LLJoint::lljoint_object_test_8")
    {
        using namespace tut;
        LLJoint lljoint("LLJoint");
        LLQuaternion q(2.3f,30.f,10.f,1.f);
    ...
    TUT_CASE("LLJoint::lljoint_object_test_9")
    {
        using namespace tut;
        LLJoint lljoint;
        LLVector3 vec3(2.3f,30.f,10.f);
    ...
    TUT_CASE("LLJoint::lljoint_object_test_10")
    {
        using namespace tut;
        LLJoint lljoint("LLJoint");
        LLMatrix4 mat;
    ...
    TUT_CASE("LLJoint::lljoint_object_test_11")
    {
        using namespace tut;
        S32 joint_num = 12;
    ...
    TUT_CASE("LLJoint::lljoint_object_test_12")
    {
        using namespace tut;
        LLJoint lljoint;
        LLVector3 vec3(2.3f,30.f,10.f);
    ...
    TUT_CASE("LLJoint::lljoint_object_test_13")
    {
        using namespace tut;
    ...
    TUT_CASE("LLJoint::lljoint_object_test_14")
    {
        using namespace tut;
        LLJoint lljointgp("gparent");
