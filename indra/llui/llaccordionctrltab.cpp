    ...
    ,mScrollbar(NULL)
{
    ...
    LLFocusableElement::setFocusReceivedCallback([this](LLFocusableElement*) { selectOnFocusReceived(); });

    if (!p.selection_enabled)
    {
        LLFocusableElement::setFocusLostCallback([this](LLFocusableElement*) { deselectOnFocusLost(); });
    }
