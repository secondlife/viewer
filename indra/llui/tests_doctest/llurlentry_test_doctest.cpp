...
TUT_SUITE("LLUrlEntry")
{
                   ...
                   const char *text, const std::string &expected)
    {
        ...
        tut_compat::ensure_equals(testname, url, expected);
    }
                   ...
                   const char *text, const std::string &expected)
    {
        ...
        tut_compat::ensure_equals(testname, label, expected);
    }
                      ...
                      const char *text, const std::string &expected)
    {
        ...
        tut_compat::ensure_equals(testname, location, expected);
    }


        TUT_CASE("LLUrlEntry::object_test_1")
    {
        using namespace tut;
        //
        ...
        TUT_CASE("LLUrlEntry::object_test_2")
    {
        using namespace tut;
        //
        ...
        TUT_CASE("LLUrlEntry::object_test_3")
    {
        using namespace tut;
        //
        ...
        TUT_CASE("LLUrlEntry::object_test_4")
    {
        using namespace tut;
        //
        ...
        TUT_CASE("LLUrlEntry::object_test_5")
    {
        using namespace tut;
        //
        ...
        TUT_CASE("LLUrlEntry::object_test_6")
    {
        using namespace tut;
        //
        ...
        TUT_CASE("LLUrlEntry::object_test_7")
    {
        using namespace tut;
        //
        ...
        TUT_CASE("LLUrlEntry::object_test_8")
    {
        using namespace tut;
        //
        ...
        TUT_CASE("LLUrlEntry::object_test_9")
    {
        using namespace tut;
        //
        ...
        TUT_CASE("LLUrlEntry::object_test_10")
    {
        using namespace tut;
        //
        ...
        TUT_CASE("LLUrlEntry::object_test_11")
    {
        using namespace tut;
        //
        ...
        TUT_CASE("LLUrlEntry::object_test_12")
    {
        using namespace tut;
        //
        ...
        TUT_CASE("LLUrlEntry::object_test_13")
    {
        using namespace tut;
        //
        ...
        TUT_CASE("LLUrlEntry::object_test_14")
    {
        using namespace tut;
        //
        ...
        TUT_CASE("LLUrlEntry::object_test_15")
    {
        using namespace tut;
        //
        // test LLUrlEntrySimpleSecondlifeURL - http://*.secondlife.com and http://*lindenlab.com urls
        ...
        TUT_CASE("LLUrlEntry::object_test_16")
    {
        using namespace tut;
        //
        // test LLUrlEntryIPv6
