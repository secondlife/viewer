...
namespace tut
{
    struct data
    {
                ...
                LLHost("127.0.0.1", commtest_data::getport("PORT")).getString())
        {
            ...
            gSavedSettings.declareBOOL("BrowserProxyEnabled", FALSE, "", LLControlVariable::ePersist::PERSIST_NO); // don't persist
            gSavedSettings.declareBOOL("NoVerifySSLCert", TRUE, "", LLControlVariable::ePersist::PERSIST_NO); // don't persist
        }
