...
void LLLandmarksPanel::doCreatePick(LLLandmark* landmark, const LLUUID &item_id)
{
    ...
    LLVector3 region_pos(static_cast<F32>(fmod(pos_global.mdV[VX], (F64)REGION_WIDTH_METERS)),
                      static_cast<F32>(fmod(pos_global.mdV[VY], (F64)REGION_WIDTH_METERS)),
...
static void collapse_all_folders(LLFolderView* root_folder)
{
    ...
    root_folder->setOpenArrangeRecursively(false, LLFolderViewFolder::ERecurseType::RECURSE_DOWN);
