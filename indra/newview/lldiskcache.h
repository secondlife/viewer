/**
 * @file lldiskcache.h
 * @brief Declaration of the disk cache API
 *
...
// toys with the idea of a variety of approaches and thought have an
// abstract base class with which to hang different imp,ementations
// off was a good idea but I think we settled on a single approach
// so I will likely remove this level of indirection  eventually.
