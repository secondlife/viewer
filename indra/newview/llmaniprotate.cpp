...
void LLManipRotate::render()
{
    ...
    gGL.pushMatrix();
    {
        ...
        {
            mManipulatorScales = ll_lerp(mManipulatorScales, LLVector4(1.f, 1.f, SELECTED_MANIPULATOR_SCALE, 1.f), LLSmoothInterpolation::getInterpolant(MANIPULATOR_SCALE_HALF_LIFE));
            gGL.pushMatrix();
            {
                // selected part
        ...
        {
            mManipulatorScales = ll_lerp(mManipulatorScales, LLVector4(1.f, SELECTED_MANIPULATOR_SCALE, 1.f, 1.f), LLSmoothInterpolation::getInterpolant(MANIPULATOR_SCALE_HALF_LIFE));
            gGL.pushMatrix();
            {
        ...
        {
            mManipulatorScales = ll_lerp(mManipulatorScales, LLVector4(SELECTED_MANIPULATOR_SCALE, 1.f, 1.f, 1.f), LLSmoothInterpolation::getInterpolant(MANIPULATOR_SCALE_HALF_LIFE));
            gGL.pushMatrix();
            {
        ...
        {
            mManipulatorScales = ll_lerp(mManipulatorScales, LLVector4(1.f, 1.f, 1.f, SELECTED_MANIPULATOR_SCALE), LLSmoothInterpolation::getInterpolant(MANIPULATOR_SCALE_HALF_LIFE));
        }
        else if (mManipPart == LL_NO_PART)
        {
            if (mHighlightedPart == LL_NO_PART)
            {
                mManipulatorScales = ll_lerp(mManipulatorScales, LLVector4(1.f, 1.f, 1.f, 1.f), LLSmoothInterpolation::getInterpolant(MANIPULATOR_SCALE_HALF_LIFE));
            }
