...
namespace
{
    ...
    static constexpr S32 NO_VERSION = LLViewerInventoryCategory::VERSION_UNKNOWN;
}
    ...
    : rv{true}
{
    ...
    if (!temp_cats.empty())
    {
        inventory_filename = LLInventoryModel::getInvCacheAddres(owner_id);
        gzip_filename = inventory_filename;
