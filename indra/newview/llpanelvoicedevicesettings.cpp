    ...
    if(!device_settings_available)
    {
        ...
        if(mCtrlInputDevices)
        {
            ...
            else
            {
                ...
                // But show 'default' as a placeholder label.
                // Combo is disabled so it's safe to show
                // a placeholder.
                mCtrlInputDevices->add(getLocalizedDeviceName(DEFAULT_DEVICE), mInputDevice, ADD_BOTTOM);
            }
            mCtrlInputDevices->setValue(mInputDevice);
        }
        if(mCtrlOutputDevices)
        {
            ...
            else
            {
                ...
                mCtrlOutputDevices->add(getLocalizedDeviceName(DEFAULT_DEVICE), mOutputDevice, ADD_BOTTOM);
            }
            mCtrlOutputDevices->setValue(mOutputDevice);
        }
    }
