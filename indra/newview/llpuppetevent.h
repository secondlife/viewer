...
public:
    ...
    static constexpr U32 PUPPET_POS_ATTCH   = 0b00000000000000000000001000000000; // Position target is an attachment point.
    static constexpr U32 PUPPET_POS_TARGET  = 0b00000000000000000000010000000000; // Position target is a task
    static constexpr U32 PUPPET_ROT_TOWARD  = 0b00000000000000000000100000000000; // Rotation should be towards the target rather than matching it.
    static constexpr U32 PUPPET_ROT_ATTCH   = 0b00000000000000000010000000000000; // Rotation target is an attachment point.
    static constexpr U32 PUPPET_ROT_TARGET  = 0b00000000000000000100000000000000; // Rotation target is a task
    static constexpr U32 PUPPET_TARGET_AVI  = 0b00000000000000100000000000000000; // Target is an agent

    static constexpr U32 PUPPET_POSITION = (PUPPET_POS_LOC | PUPPET_POS_ABS | PUPPET_POS_ATTCH | PUPPET_POS_TARGET);
    static constexpr U32 PUPPET_ROTATION = (PUPPET_ROT_LOC | PUPPET_ROT_ABS | PUPPET_ROT_ATTCH | PUPPET_ROT_TARGET | PUPPET_ROT_TOWARD);
