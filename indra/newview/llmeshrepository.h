...
public:
	...
	static F32 getChargedTriangleCount(std::vector<F32>& counts_by_lod);
...
public:
	...
	S32 loadMesh(const LLVOVolume* volume, const LLVolumeParams& mesh_params, S32 detail = 0, S32 last_lod = -1);
