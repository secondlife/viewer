...
public:
	...
	// /*virtual*/ U32 render(U32 render_pass_type, F32 pixelArea, bool first_pass = true, bool is_dummy = false ) { return LLViewerJoint::render(render_pass_type, pixelArea,first_pass,is_dummy);}
	/*virtual*/ U32 render(U32 render_pass_type, F32 pixelArea, bool first_pass, bool is_dummy) { return LLViewerJoint::render(render_pass_type, pixelArea,first_pass,is_dummy);}
