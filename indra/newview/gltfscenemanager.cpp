...
void GLTFSceneManager::render(Asset& asset, U8 variant)
{
    ...
    static LLCachedControl<bool> sRenderCanUseGLTFPBROpaqueShaders(gSavedSettings, "RenderCanUseGLTFPBROpaqueShaders", true);
    if (!sRenderCanUseGLTFPBROpaqueShaders)
    {
