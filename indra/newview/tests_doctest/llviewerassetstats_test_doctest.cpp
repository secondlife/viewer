...
TUT_SUITE("tst_viewerassetstats_test")
{
    TUT_CASE("tst_viewerassetstats_test::test_1")
    {
        using namespace tut;
        tst_viewerassetstats_index data;
        (void)data;
    ...
    TUT_CASE("tst_viewerassetstats_test::test_2")
    {
        using namespace tut;
        tst_viewerassetstats_index data;
        (void)data;
    ...
    TUT_CASE("tst_viewerassetstats_test::test_3")
    {
        using namespace tut;
        tst_viewerassetstats_index data;
        (void)data;
    ...
    TUT_CASE("tst_viewerassetstats_test::test_4")
    {
        using namespace tut;
        tst_viewerassetstats_index data;
        (void)data;
    ...
    TUT_CASE("tst_viewerassetstats_test::test_5")
    {
        using namespace tut;
        tst_viewerassetstats_index data;
        (void)data;
    ...
    TUT_CASE("tst_viewerassetstats_test::test_6")
    {
        using namespace tut;
        tst_viewerassetstats_index data;
        (void)data;
    ...
    TUT_CASE("tst_viewerassetstats_test::test_7")
    {
        using namespace tut;
        tst_viewerassetstats_index data;
        (void)data;
