...
TUT_SUITE("LLViewerNetwork")
{
    TUT_CASE("LLViewerNetwork::test_1")
    {
        using namespace tut;
        viewerNetworkTest data;
        (void)data;
        ...
        ensure_equals("update url base for Agni",
    ...
    TUT_CASE("LLViewerNetwork::test_2")
    {
        using namespace tut;
        viewerNetworkTest data;
        (void)data;
    ...
    TUT_CASE("LLViewerNetwork::test_7")
    {
        using namespace tut;
        viewerNetworkTest data;
        (void)data;
