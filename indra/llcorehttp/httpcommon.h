...
///                                  const HttpResponse::ptr_t &response)
///         {
///             ...
///         }
///         ...
...
struct HttpStatus
{
	...
	static const type_enum_t EXT_CURL_EASY;			    ///< mStatus is an error from a curl_easy_*() call
	static const type_enum_t EXT_CURL_MULTI;		    ///< mStatus is an error from a curl_multi_*() call
	static const type_enum_t LLCORE;				    ///< mStatus is an HE_* error code
