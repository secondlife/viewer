...
public:
	...
	virtual LLGLTexture::ptr_t getLocalTexture(bool usemipmaps = true, bool generate_gl_tex = true) = 0;
	virtual LLGLTexture::ptr_t getLocalTexture(const U32 width, const U32 height, const U8 components, bool usemipmaps, bool generate_gl_tex = true) = 0;
	virtual LLGLTexture::ptr_t getFetchedTexture(const LLUUID &image_id) = 0;
};
